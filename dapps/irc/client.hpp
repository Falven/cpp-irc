...
namespace dapps
{
    namespace irc
    {
        ...
        public:
            ...
            ///////////////////////////////////////////////////////////////////////////
            reply connect(const std::string & pass, const nickname & nick, const username & user)
            {
                message_password();
                message_nickname();
                message_user();
        ...
        private:
            ...
            void send_message(const message & msg)
            {
                ...
                //                          boost::bind(&client::handle_send_message, this, boost::asio::placeholders::error));
            }

            void handle_send_message(const boost::system::error_code & error)
            {
                if (error)
                {
                    throw irc_exception("Failed to send message: " + error.message());
                }
            }
            ...
            reply receive_reply()
            {
                ...
                //                         boost::asio::buffer(reply_str, 1),
                //                         boost::bind(&client::handle_receive_reply, this, boost::asio::placeholders::error));
            }

            void handle_receive_reply(const boost::system::error_code & error)
            {
                if (error)
                {
                    throw irc_exception("Failed to receive reply: " + error.message());
                }
            }
        };
    }
