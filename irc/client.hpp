		...
		private:
			...
			void chain_request(const message & msg)
			{
					...
					[this](const boost::system::error_code & error, std::size_t)
				{
					if (error)
					{
						throw irc_exception("Send message failed: " + error.message());
					}
				});
			}
			...
			void chain_reply()
			{
					...
					[this](const boost::system::error_code & error, std::size_t)
				{
					if (error)
					{
						throw irc_exception("Receive reply failed: " + error.message());
					}
